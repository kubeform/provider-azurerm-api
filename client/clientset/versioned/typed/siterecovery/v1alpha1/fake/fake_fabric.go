...
var fabricsResource = schema.GroupVersionResource{Group: "siterecovery.azurerm.kubeform.com", Version: "v1alpha1", Resource: "fabrics"}

var fabricsKind = schema.GroupVersionKind{Group: "siterecovery.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Fabric"}
...
func (c *FakeFabrics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Fabric, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(fabricsResource, c.ns, name), &v1alpha1.Fabric{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Fabric), err
}
...
func (c *FakeFabrics) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FabricList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(fabricsResource, fabricsKind, c.ns, opts), &v1alpha1.FabricList{})
	...
	list := &v1alpha1.FabricList{ListMeta: obj.(*v1alpha1.FabricList).ListMeta}
	for _, item := range obj.(*v1alpha1.FabricList).Items {
...
func (c *FakeFabrics) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(fabricsResource, c.ns, opts))
...
func (c *FakeFabrics) Create(ctx context.Context, fabric *v1alpha1.Fabric, opts v1.CreateOptions) (result *v1alpha1.Fabric, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(fabricsResource, c.ns, fabric), &v1alpha1.Fabric{})
...
func (c *FakeFabrics) Update(ctx context.Context, fabric *v1alpha1.Fabric, opts v1.UpdateOptions) (result *v1alpha1.Fabric, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(fabricsResource, c.ns, fabric), &v1alpha1.Fabric{})
...
func (c *FakeFabrics) UpdateStatus(ctx context.Context, fabric *v1alpha1.Fabric, opts v1.UpdateOptions) (*v1alpha1.Fabric, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(fabricsResource, "status", c.ns, fabric), &v1alpha1.Fabric{})
...
func (c *FakeFabrics) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(fabricsResource, c.ns, name), &v1alpha1.Fabric{})
...
func (c *FakeFabrics) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(fabricsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.FabricList{})
	return err
}
...
func (c *FakeFabrics) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Fabric, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(fabricsResource, c.ns, name, pt, data, subresources...), &v1alpha1.Fabric{})
