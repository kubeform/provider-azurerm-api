...
type FakeVirtualMachineScaleSets struct {
	Fake *FakeWindowsV1alpha1
	ns   string
}

var virtualmachinescalesetsResource = schema.GroupVersionResource{Group: "windows.azurerm.kubeform.com", Version: "v1alpha1", Resource: "virtualmachinescalesets"}

var virtualmachinescalesetsKind = schema.GroupVersionKind{Group: "windows.azurerm.kubeform.com", Version: "v1alpha1", Kind: "VirtualMachineScaleSet"}
