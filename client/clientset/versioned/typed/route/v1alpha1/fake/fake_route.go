...
var routesResource = schema.GroupVersionResource{Group: "route.azurerm.kubeform.com", Version: "v1alpha1", Resource: "routes"}

var routesKind = schema.GroupVersionKind{Group: "route.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Route"}
