...
var connectionmonitorsResource = schema.GroupVersionResource{Group: "network.azurerm.kubeform.com", Version: "v1alpha1", Resource: "connectionmonitors"}

var connectionmonitorsKind = schema.GroupVersionKind{Group: "network.azurerm.kubeform.com", Version: "v1alpha1", Kind: "ConnectionMonitor"}
...
func (c *FakeConnectionMonitors) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ConnectionMonitor, err error) {
	...
	return obj.(*v1alpha1.ConnectionMonitor), err
}
...
func (c *FakeConnectionMonitors) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ConnectionMonitorList, err error) {
	...
	list := &v1alpha1.ConnectionMonitorList{ListMeta: obj.(*v1alpha1.ConnectionMonitorList).ListMeta}
	for _, item := range obj.(*v1alpha1.ConnectionMonitorList).Items {
