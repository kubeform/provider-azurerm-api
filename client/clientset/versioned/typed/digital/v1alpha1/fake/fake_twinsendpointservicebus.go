...
var twinsendpointservicebusesResource = schema.GroupVersionResource{Group: "digital.azurerm.kubeform.com", Version: "v1alpha1", Resource: "twinsendpointservicebuses"}

var twinsendpointservicebusesKind = schema.GroupVersionKind{Group: "digital.azurerm.kubeform.com", Version: "v1alpha1", Kind: "TwinsEndpointServicebus"}
...
func (c *FakeTwinsEndpointServicebuses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TwinsEndpointServicebus, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(twinsendpointservicebusesResource, c.ns, name), &v1alpha1.TwinsEndpointServicebus{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TwinsEndpointServicebus), err
}
...
func (c *FakeTwinsEndpointServicebuses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TwinsEndpointServicebusList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(twinsendpointservicebusesResource, twinsendpointservicebusesKind, c.ns, opts), &v1alpha1.TwinsEndpointServicebusList{})
	...
	list := &v1alpha1.TwinsEndpointServicebusList{ListMeta: obj.(*v1alpha1.TwinsEndpointServicebusList).ListMeta}
	for _, item := range obj.(*v1alpha1.TwinsEndpointServicebusList).Items {
...
func (c *FakeTwinsEndpointServicebuses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(twinsendpointservicebusesResource, c.ns, opts))
...
func (c *FakeTwinsEndpointServicebuses) Create(ctx context.Context, twinsEndpointServicebus *v1alpha1.TwinsEndpointServicebus, opts v1.CreateOptions) (result *v1alpha1.TwinsEndpointServicebus, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(twinsendpointservicebusesResource, c.ns, twinsEndpointServicebus), &v1alpha1.TwinsEndpointServicebus{})
...
func (c *FakeTwinsEndpointServicebuses) Update(ctx context.Context, twinsEndpointServicebus *v1alpha1.TwinsEndpointServicebus, opts v1.UpdateOptions) (result *v1alpha1.TwinsEndpointServicebus, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(twinsendpointservicebusesResource, c.ns, twinsEndpointServicebus), &v1alpha1.TwinsEndpointServicebus{})
...
func (c *FakeTwinsEndpointServicebuses) UpdateStatus(ctx context.Context, twinsEndpointServicebus *v1alpha1.TwinsEndpointServicebus, opts v1.UpdateOptions) (*v1alpha1.TwinsEndpointServicebus, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(twinsendpointservicebusesResource, "status", c.ns, twinsEndpointServicebus), &v1alpha1.TwinsEndpointServicebus{})
...
func (c *FakeTwinsEndpointServicebuses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(twinsendpointservicebusesResource, c.ns, name), &v1alpha1.TwinsEndpointServicebus{})
...
func (c *FakeTwinsEndpointServicebuses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(twinsendpointservicebusesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.TwinsEndpointServicebusList{})
	return err
}
...
func (c *FakeTwinsEndpointServicebuses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TwinsEndpointServicebus, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(twinsendpointservicebusesResource, c.ns, name, pt, data, subresources...), &v1alpha1.TwinsEndpointServicebus{})
