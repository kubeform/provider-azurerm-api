...
var hadoopclustersResource = schema.GroupVersionResource{Group: "hdinsight.azurerm.kubeform.com", Version: "v1alpha1", Resource: "hadoopclusters"}

var hadoopclustersKind = schema.GroupVersionKind{Group: "hdinsight.azurerm.kubeform.com", Version: "v1alpha1", Kind: "HadoopCluster"}
...
func (c *FakeHadoopClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(hadoopclustersResource, c.ns, name), &v1alpha1.HadoopCluster{})
