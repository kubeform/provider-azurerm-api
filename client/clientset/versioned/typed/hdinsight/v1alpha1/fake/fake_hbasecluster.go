...
var hbaseclustersResource = schema.GroupVersionResource{Group: "hdinsight.azurerm.kubeform.com", Version: "v1alpha1", Resource: "hbaseclusters"}

var hbaseclustersKind = schema.GroupVersionKind{Group: "hdinsight.azurerm.kubeform.com", Version: "v1alpha1", Kind: "HbaseCluster"}
...
func (c *FakeHbaseClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HbaseCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(hbaseclustersResource, c.ns, name), &v1alpha1.HbaseCluster{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.HbaseCluster), err
}
...
func (c *FakeHbaseClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HbaseClusterList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(hbaseclustersResource, hbaseclustersKind, c.ns, opts), &v1alpha1.HbaseClusterList{})
	...
	list := &v1alpha1.HbaseClusterList{ListMeta: obj.(*v1alpha1.HbaseClusterList).ListMeta}
	for _, item := range obj.(*v1alpha1.HbaseClusterList).Items {
...
func (c *FakeHbaseClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(hbaseclustersResource, c.ns, opts))
...
func (c *FakeHbaseClusters) Create(ctx context.Context, hbaseCluster *v1alpha1.HbaseCluster, opts v1.CreateOptions) (result *v1alpha1.HbaseCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(hbaseclustersResource, c.ns, hbaseCluster), &v1alpha1.HbaseCluster{})
...
func (c *FakeHbaseClusters) Update(ctx context.Context, hbaseCluster *v1alpha1.HbaseCluster, opts v1.UpdateOptions) (result *v1alpha1.HbaseCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(hbaseclustersResource, c.ns, hbaseCluster), &v1alpha1.HbaseCluster{})
...
func (c *FakeHbaseClusters) UpdateStatus(ctx context.Context, hbaseCluster *v1alpha1.HbaseCluster, opts v1.UpdateOptions) (*v1alpha1.HbaseCluster, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(hbaseclustersResource, "status", c.ns, hbaseCluster), &v1alpha1.HbaseCluster{})
...
func (c *FakeHbaseClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(hbaseclustersResource, c.ns, name), &v1alpha1.HbaseCluster{})
...
func (c *FakeHbaseClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(hbaseclustersResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.HbaseClusterList{})
	return err
}
...
func (c *FakeHbaseClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HbaseCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(hbaseclustersResource, c.ns, name, pt, data, subresources...), &v1alpha1.HbaseCluster{})
