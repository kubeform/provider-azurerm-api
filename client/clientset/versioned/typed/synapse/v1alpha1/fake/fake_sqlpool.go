...
var sqlpoolsResource = schema.GroupVersionResource{Group: "synapse.azurerm.kubeform.com", Version: "v1alpha1", Resource: "sqlpools"}

var sqlpoolsKind = schema.GroupVersionKind{Group: "synapse.azurerm.kubeform.com", Version: "v1alpha1", Kind: "SqlPool"}
...
func (c *FakeSqlPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SqlPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(sqlpoolsResource, c.ns, name), &v1alpha1.SqlPool{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SqlPool), err
}
...
func (c *FakeSqlPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SqlPoolList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(sqlpoolsResource, sqlpoolsKind, c.ns, opts), &v1alpha1.SqlPoolList{})
	...
	list := &v1alpha1.SqlPoolList{ListMeta: obj.(*v1alpha1.SqlPoolList).ListMeta}
	for _, item := range obj.(*v1alpha1.SqlPoolList).Items {
...
func (c *FakeSqlPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(sqlpoolsResource, c.ns, opts))
...
func (c *FakeSqlPools) Create(ctx context.Context, sqlPool *v1alpha1.SqlPool, opts v1.CreateOptions) (result *v1alpha1.SqlPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(sqlpoolsResource, c.ns, sqlPool), &v1alpha1.SqlPool{})
...
func (c *FakeSqlPools) Update(ctx context.Context, sqlPool *v1alpha1.SqlPool, opts v1.UpdateOptions) (result *v1alpha1.SqlPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(sqlpoolsResource, c.ns, sqlPool), &v1alpha1.SqlPool{})
...
func (c *FakeSqlPools) UpdateStatus(ctx context.Context, sqlPool *v1alpha1.SqlPool, opts v1.UpdateOptions) (*v1alpha1.SqlPool, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(sqlpoolsResource, "status", c.ns, sqlPool), &v1alpha1.SqlPool{})
...
func (c *FakeSqlPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(sqlpoolsResource, c.ns, name), &v1alpha1.SqlPool{})
...
func (c *FakeSqlPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(sqlpoolsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.SqlPoolList{})
	return err
}
...
func (c *FakeSqlPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SqlPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(sqlpoolsResource, c.ns, name, pt, data, subresources...), &v1alpha1.SqlPool{})
