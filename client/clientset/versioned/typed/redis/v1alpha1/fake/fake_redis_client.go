...
import (
	v1alpha1 "kubeform.dev/provider-azurerm-api/client/clientset/versioned/typed/redis/v1alpha1"
...
func (c *FakeRedisV1alpha1) LinkedServers(namespace string) v1alpha1.LinkedServerInterface {
	return &FakeLinkedServers{c, namespace}
}
