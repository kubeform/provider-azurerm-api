...
type FakeControllers struct {
	Fake *FakeDevspaceV1alpha1
	ns   string
}

var controllersResource = schema.GroupVersionResource{Group: "devspace.azurerm.kubeform.com", Version: "v1alpha1", Resource: "controllers"}

var controllersKind = schema.GroupVersionKind{Group: "devspace.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Controller"}
