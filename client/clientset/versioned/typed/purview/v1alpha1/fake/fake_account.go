...
type FakeAccounts struct {
	Fake *FakePurviewV1alpha1
	ns   string
}

var accountsResource = schema.GroupVersionResource{Group: "purview.azurerm.kubeform.com", Version: "v1alpha1", Resource: "accounts"}

var accountsKind = schema.GroupVersionKind{Group: "purview.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Account"}
