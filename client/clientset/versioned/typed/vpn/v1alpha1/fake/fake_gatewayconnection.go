...
var gatewayconnectionsResource = schema.GroupVersionResource{Group: "vpn.azurerm.kubeform.com", Version: "v1alpha1", Resource: "gatewayconnections"}

var gatewayconnectionsKind = schema.GroupVersionKind{Group: "vpn.azurerm.kubeform.com", Version: "v1alpha1", Kind: "GatewayConnection"}
...
func (c *FakeGatewayConnections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GatewayConnection, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(gatewayconnectionsResource, c.ns, name), &v1alpha1.GatewayConnection{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.GatewayConnection), err
}
...
func (c *FakeGatewayConnections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GatewayConnectionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(gatewayconnectionsResource, gatewayconnectionsKind, c.ns, opts), &v1alpha1.GatewayConnectionList{})
	...
	list := &v1alpha1.GatewayConnectionList{ListMeta: obj.(*v1alpha1.GatewayConnectionList).ListMeta}
	for _, item := range obj.(*v1alpha1.GatewayConnectionList).Items {
...
func (c *FakeGatewayConnections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(gatewayconnectionsResource, c.ns, opts))
...
func (c *FakeGatewayConnections) Create(ctx context.Context, gatewayConnection *v1alpha1.GatewayConnection, opts v1.CreateOptions) (result *v1alpha1.GatewayConnection, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(gatewayconnectionsResource, c.ns, gatewayConnection), &v1alpha1.GatewayConnection{})
...
func (c *FakeGatewayConnections) Update(ctx context.Context, gatewayConnection *v1alpha1.GatewayConnection, opts v1.UpdateOptions) (result *v1alpha1.GatewayConnection, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(gatewayconnectionsResource, c.ns, gatewayConnection), &v1alpha1.GatewayConnection{})
...
func (c *FakeGatewayConnections) UpdateStatus(ctx context.Context, gatewayConnection *v1alpha1.GatewayConnection, opts v1.UpdateOptions) (*v1alpha1.GatewayConnection, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(gatewayconnectionsResource, "status", c.ns, gatewayConnection), &v1alpha1.GatewayConnection{})
...
func (c *FakeGatewayConnections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(gatewayconnectionsResource, c.ns, name), &v1alpha1.GatewayConnection{})
...
func (c *FakeGatewayConnections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(gatewayconnectionsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.GatewayConnectionList{})
	return err
}
...
func (c *FakeGatewayConnections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GatewayConnection, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(gatewayconnectionsResource, c.ns, name, pt, data, subresources...), &v1alpha1.GatewayConnection{})
