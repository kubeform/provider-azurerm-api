...
var providersResource = schema.GroupVersionResource{Group: "attestation.azurerm.kubeform.com", Version: "v1alpha1", Resource: "providers"}

var providersKind = schema.GroupVersionKind{Group: "attestation.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Provider"}
...
func (c *FakeProviders) UpdateStatus(ctx context.Context, provider *v1alpha1.Provider, opts v1.UpdateOptions) (*v1alpha1.Provider, error) {
	obj, err := c.Fake.
...
func (c *FakeProviders) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Provider, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(providersResource, c.ns, name, pt, data, subresources...), &v1alpha1.Provider{})
