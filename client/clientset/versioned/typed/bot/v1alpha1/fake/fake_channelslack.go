...
var channelslacksResource = schema.GroupVersionResource{Group: "bot.azurerm.kubeform.com", Version: "v1alpha1", Resource: "channelslacks"}

var channelslacksKind = schema.GroupVersionKind{Group: "bot.azurerm.kubeform.com", Version: "v1alpha1", Kind: "ChannelSlack"}
...
func (c *FakeChannelSlacks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ChannelSlack, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(channelslacksResource, c.ns, name), &v1alpha1.ChannelSlack{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ChannelSlack), err
}
...
func (c *FakeChannelSlacks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ChannelSlackList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(channelslacksResource, channelslacksKind, c.ns, opts), &v1alpha1.ChannelSlackList{})
	...
	list := &v1alpha1.ChannelSlackList{ListMeta: obj.(*v1alpha1.ChannelSlackList).ListMeta}
	for _, item := range obj.(*v1alpha1.ChannelSlackList).Items {
...
func (c *FakeChannelSlacks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(channelslacksResource, c.ns, opts))
...
func (c *FakeChannelSlacks) Create(ctx context.Context, channelSlack *v1alpha1.ChannelSlack, opts v1.CreateOptions) (result *v1alpha1.ChannelSlack, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(channelslacksResource, c.ns, channelSlack), &v1alpha1.ChannelSlack{})
...
func (c *FakeChannelSlacks) Update(ctx context.Context, channelSlack *v1alpha1.ChannelSlack, opts v1.UpdateOptions) (result *v1alpha1.ChannelSlack, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(channelslacksResource, c.ns, channelSlack), &v1alpha1.ChannelSlack{})
...
func (c *FakeChannelSlacks) UpdateStatus(ctx context.Context, channelSlack *v1alpha1.ChannelSlack, opts v1.UpdateOptions) (*v1alpha1.ChannelSlack, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(channelslacksResource, "status", c.ns, channelSlack), &v1alpha1.ChannelSlack{})
...
func (c *FakeChannelSlacks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(channelslacksResource, c.ns, name), &v1alpha1.ChannelSlack{})
...
func (c *FakeChannelSlacks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(channelslacksResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.ChannelSlackList{})
	return err
}
...
func (c *FakeChannelSlacks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ChannelSlack, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(channelslacksResource, c.ns, name, pt, data, subresources...), &v1alpha1.ChannelSlack{})
