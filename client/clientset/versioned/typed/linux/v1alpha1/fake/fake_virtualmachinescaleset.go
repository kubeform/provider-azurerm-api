...
type FakeVirtualMachineScaleSets struct {
	Fake *FakeLinuxV1alpha1
	ns   string
}

var virtualmachinescalesetsResource = schema.GroupVersionResource{Group: "linux.azurerm.kubeform.com", Version: "v1alpha1", Resource: "virtualmachinescalesets"}

var virtualmachinescalesetsKind = schema.GroupVersionKind{Group: "linux.azurerm.kubeform.com", Version: "v1alpha1", Kind: "VirtualMachineScaleSet"}
