...
var serversResource = schema.GroupVersionResource{Group: "mysql.azurerm.kubeform.com", Version: "v1alpha1", Resource: "servers"}

var serversKind = schema.GroupVersionKind{Group: "mysql.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Server"}
