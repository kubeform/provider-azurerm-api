...
type FakeDedicatedHosts struct {
	Fake *FakeDedicatedhostV1alpha1
	ns   string
}

var dedicatedhostsResource = schema.GroupVersionResource{Group: "dedicatedhost.azurerm.kubeform.com", Version: "v1alpha1", Resource: "dedicatedhosts"}

var dedicatedhostsKind = schema.GroupVersionKind{Group: "dedicatedhost.azurerm.kubeform.com", Version: "v1alpha1", Kind: "DedicatedHost"}
