...
var groupusersResource = schema.GroupVersionResource{Group: "apimanagement.azurerm.kubeform.com", Version: "v1alpha1", Resource: "groupusers"}

var groupusersKind = schema.GroupVersionKind{Group: "apimanagement.azurerm.kubeform.com", Version: "v1alpha1", Kind: "GroupUser"}
...
func (c *FakeGroupUsers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GroupUser, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(groupusersResource, c.ns, name), &v1alpha1.GroupUser{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.GroupUser), err
}
...
func (c *FakeGroupUsers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GroupUserList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(groupusersResource, groupusersKind, c.ns, opts), &v1alpha1.GroupUserList{})
	...
	list := &v1alpha1.GroupUserList{ListMeta: obj.(*v1alpha1.GroupUserList).ListMeta}
	for _, item := range obj.(*v1alpha1.GroupUserList).Items {
...
func (c *FakeGroupUsers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(groupusersResource, c.ns, opts))
...
func (c *FakeGroupUsers) Create(ctx context.Context, groupUser *v1alpha1.GroupUser, opts v1.CreateOptions) (result *v1alpha1.GroupUser, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(groupusersResource, c.ns, groupUser), &v1alpha1.GroupUser{})
...
func (c *FakeGroupUsers) Update(ctx context.Context, groupUser *v1alpha1.GroupUser, opts v1.UpdateOptions) (result *v1alpha1.GroupUser, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(groupusersResource, c.ns, groupUser), &v1alpha1.GroupUser{})
...
func (c *FakeGroupUsers) UpdateStatus(ctx context.Context, groupUser *v1alpha1.GroupUser, opts v1.UpdateOptions) (*v1alpha1.GroupUser, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(groupusersResource, "status", c.ns, groupUser), &v1alpha1.GroupUser{})
...
func (c *FakeGroupUsers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(groupusersResource, c.ns, name), &v1alpha1.GroupUser{})
...
func (c *FakeGroupUsers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(groupusersResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.GroupUserList{})
	return err
}
...
func (c *FakeGroupUsers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GroupUser, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(groupusersResource, c.ns, name, pt, data, subresources...), &v1alpha1.GroupUser{})
