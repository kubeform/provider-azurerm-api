...
var apipoliciesResource = schema.GroupVersionResource{Group: "apimanagement.azurerm.kubeform.com", Version: "v1alpha1", Resource: "apipolicies"}

var apipoliciesKind = schema.GroupVersionKind{Group: "apimanagement.azurerm.kubeform.com", Version: "v1alpha1", Kind: "ApiPolicy"}
...
func (c *FakeApiPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(apipoliciesResource, c.ns, name), &v1alpha1.ApiPolicy{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiPolicy), err
}
...
func (c *FakeApiPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(apipoliciesResource, apipoliciesKind, c.ns, opts), &v1alpha1.ApiPolicyList{})
	...
	list := &v1alpha1.ApiPolicyList{ListMeta: obj.(*v1alpha1.ApiPolicyList).ListMeta}
	for _, item := range obj.(*v1alpha1.ApiPolicyList).Items {
...
func (c *FakeApiPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(apipoliciesResource, c.ns, opts))
...
func (c *FakeApiPolicies) Create(ctx context.Context, apiPolicy *v1alpha1.ApiPolicy, opts v1.CreateOptions) (result *v1alpha1.ApiPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(apipoliciesResource, c.ns, apiPolicy), &v1alpha1.ApiPolicy{})
...
func (c *FakeApiPolicies) Update(ctx context.Context, apiPolicy *v1alpha1.ApiPolicy, opts v1.UpdateOptions) (result *v1alpha1.ApiPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(apipoliciesResource, c.ns, apiPolicy), &v1alpha1.ApiPolicy{})
...
func (c *FakeApiPolicies) UpdateStatus(ctx context.Context, apiPolicy *v1alpha1.ApiPolicy, opts v1.UpdateOptions) (*v1alpha1.ApiPolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(apipoliciesResource, "status", c.ns, apiPolicy), &v1alpha1.ApiPolicy{})
...
func (c *FakeApiPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(apipoliciesResource, c.ns, name), &v1alpha1.ApiPolicy{})
...
func (c *FakeApiPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(apipoliciesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.ApiPolicyList{})
	return err
}
...
func (c *FakeApiPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(apipoliciesResource, c.ns, name, pt, data, subresources...), &v1alpha1.ApiPolicy{})
