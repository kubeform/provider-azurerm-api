...
type FakeVirtualMachineScaleSets struct {
	Fake *FakeOrchestratedV1alpha1
	ns   string
}

var virtualmachinescalesetsResource = schema.GroupVersionResource{Group: "orchestrated.azurerm.kubeform.com", Version: "v1alpha1", Resource: "virtualmachinescalesets"}

var virtualmachinescalesetsKind = schema.GroupVersionKind{Group: "orchestrated.azurerm.kubeform.com", Version: "v1alpha1", Kind: "VirtualMachineScaleSet"}
