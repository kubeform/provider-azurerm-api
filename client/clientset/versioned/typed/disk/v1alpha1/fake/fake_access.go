...
var accessesResource = schema.GroupVersionResource{Group: "disk.azurerm.kubeform.com", Version: "v1alpha1", Resource: "accesses"}

var accessesKind = schema.GroupVersionKind{Group: "disk.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Access"}
...
func (c *FakeAccesses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(accessesResource, c.ns, name), &v1alpha1.Access{})
