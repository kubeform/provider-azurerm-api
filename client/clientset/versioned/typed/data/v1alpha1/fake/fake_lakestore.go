...
var lakestoresResource = schema.GroupVersionResource{Group: "data.azurerm.kubeform.com", Version: "v1alpha1", Resource: "lakestores"}

var lakestoresKind = schema.GroupVersionKind{Group: "data.azurerm.kubeform.com", Version: "v1alpha1", Kind: "LakeStore"}
...
func (c *FakeLakeStores) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LakeStore, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(lakestoresResource, c.ns, name), &v1alpha1.LakeStore{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.LakeStore), err
}
...
func (c *FakeLakeStores) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LakeStoreList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(lakestoresResource, lakestoresKind, c.ns, opts), &v1alpha1.LakeStoreList{})
	...
	list := &v1alpha1.LakeStoreList{ListMeta: obj.(*v1alpha1.LakeStoreList).ListMeta}
	for _, item := range obj.(*v1alpha1.LakeStoreList).Items {
...
func (c *FakeLakeStores) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(lakestoresResource, c.ns, opts))
...
func (c *FakeLakeStores) Create(ctx context.Context, lakeStore *v1alpha1.LakeStore, opts v1.CreateOptions) (result *v1alpha1.LakeStore, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(lakestoresResource, c.ns, lakeStore), &v1alpha1.LakeStore{})
...
func (c *FakeLakeStores) Update(ctx context.Context, lakeStore *v1alpha1.LakeStore, opts v1.UpdateOptions) (result *v1alpha1.LakeStore, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(lakestoresResource, c.ns, lakeStore), &v1alpha1.LakeStore{})
...
func (c *FakeLakeStores) UpdateStatus(ctx context.Context, lakeStore *v1alpha1.LakeStore, opts v1.UpdateOptions) (*v1alpha1.LakeStore, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(lakestoresResource, "status", c.ns, lakeStore), &v1alpha1.LakeStore{})
...
func (c *FakeLakeStores) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(lakestoresResource, c.ns, name), &v1alpha1.LakeStore{})
...
func (c *FakeLakeStores) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(lakestoresResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.LakeStoreList{})
	return err
}
...
func (c *FakeLakeStores) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LakeStore, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(lakestoresResource, c.ns, name, pt, data, subresources...), &v1alpha1.LakeStore{})
