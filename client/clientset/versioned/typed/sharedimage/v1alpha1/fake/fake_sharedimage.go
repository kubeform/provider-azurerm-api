...
var sharedimagesResource = schema.GroupVersionResource{Group: "sharedimage.azurerm.kubeform.com", Version: "v1alpha1", Resource: "sharedimages"}

var sharedimagesKind = schema.GroupVersionKind{Group: "sharedimage.azurerm.kubeform.com", Version: "v1alpha1", Kind: "SharedImage"}
...
func (c *FakeSharedImages) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeSharedImages) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(sharedimagesResource, c.ns, listOpts)
