...
var caarecordsResource = schema.GroupVersionResource{Group: "dns.azurerm.kubeform.com", Version: "v1alpha1", Resource: "caarecords"}

var caarecordsKind = schema.GroupVersionKind{Group: "dns.azurerm.kubeform.com", Version: "v1alpha1", Kind: "CaaRecord"}
...
func (c *FakeCaaRecords) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CaaRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(caarecordsResource, c.ns, name), &v1alpha1.CaaRecord{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CaaRecord), err
}
...
func (c *FakeCaaRecords) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CaaRecordList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(caarecordsResource, caarecordsKind, c.ns, opts), &v1alpha1.CaaRecordList{})
	...
	list := &v1alpha1.CaaRecordList{ListMeta: obj.(*v1alpha1.CaaRecordList).ListMeta}
	for _, item := range obj.(*v1alpha1.CaaRecordList).Items {
...
func (c *FakeCaaRecords) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(caarecordsResource, c.ns, opts))
...
func (c *FakeCaaRecords) Create(ctx context.Context, caaRecord *v1alpha1.CaaRecord, opts v1.CreateOptions) (result *v1alpha1.CaaRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(caarecordsResource, c.ns, caaRecord), &v1alpha1.CaaRecord{})
...
func (c *FakeCaaRecords) Update(ctx context.Context, caaRecord *v1alpha1.CaaRecord, opts v1.UpdateOptions) (result *v1alpha1.CaaRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(caarecordsResource, c.ns, caaRecord), &v1alpha1.CaaRecord{})
...
func (c *FakeCaaRecords) UpdateStatus(ctx context.Context, caaRecord *v1alpha1.CaaRecord, opts v1.UpdateOptions) (*v1alpha1.CaaRecord, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(caarecordsResource, "status", c.ns, caaRecord), &v1alpha1.CaaRecord{})
...
func (c *FakeCaaRecords) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(caarecordsResource, c.ns, name), &v1alpha1.CaaRecord{})
...
func (c *FakeCaaRecords) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(caarecordsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.CaaRecordList{})
	return err
}
...
func (c *FakeCaaRecords) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CaaRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(caarecordsResource, c.ns, name, pt, data, subresources...), &v1alpha1.CaaRecord{})
