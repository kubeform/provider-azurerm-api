...
var aaaarecordsResource = schema.GroupVersionResource{Group: "dns.azurerm.kubeform.com", Version: "v1alpha1", Resource: "aaaarecords"}

var aaaarecordsKind = schema.GroupVersionKind{Group: "dns.azurerm.kubeform.com", Version: "v1alpha1", Kind: "AaaaRecord"}
...
func (c *FakeAaaaRecords) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AaaaRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(aaaarecordsResource, c.ns, name), &v1alpha1.AaaaRecord{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AaaaRecord), err
}
...
func (c *FakeAaaaRecords) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AaaaRecordList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(aaaarecordsResource, aaaarecordsKind, c.ns, opts), &v1alpha1.AaaaRecordList{})
	...
	list := &v1alpha1.AaaaRecordList{ListMeta: obj.(*v1alpha1.AaaaRecordList).ListMeta}
	for _, item := range obj.(*v1alpha1.AaaaRecordList).Items {
...
func (c *FakeAaaaRecords) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(aaaarecordsResource, c.ns, opts))
...
func (c *FakeAaaaRecords) Create(ctx context.Context, aaaaRecord *v1alpha1.AaaaRecord, opts v1.CreateOptions) (result *v1alpha1.AaaaRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(aaaarecordsResource, c.ns, aaaaRecord), &v1alpha1.AaaaRecord{})
...
func (c *FakeAaaaRecords) Update(ctx context.Context, aaaaRecord *v1alpha1.AaaaRecord, opts v1.UpdateOptions) (result *v1alpha1.AaaaRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(aaaarecordsResource, c.ns, aaaaRecord), &v1alpha1.AaaaRecord{})
...
func (c *FakeAaaaRecords) UpdateStatus(ctx context.Context, aaaaRecord *v1alpha1.AaaaRecord, opts v1.UpdateOptions) (*v1alpha1.AaaaRecord, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(aaaarecordsResource, "status", c.ns, aaaaRecord), &v1alpha1.AaaaRecord{})
...
func (c *FakeAaaaRecords) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(aaaarecordsResource, c.ns, name), &v1alpha1.AaaaRecord{})
...
func (c *FakeAaaaRecords) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(aaaarecordsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.AaaaRecordList{})
	return err
}
...
func (c *FakeAaaaRecords) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AaaaRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(aaaarecordsResource, c.ns, name, pt, data, subresources...), &v1alpha1.AaaaRecord{})
