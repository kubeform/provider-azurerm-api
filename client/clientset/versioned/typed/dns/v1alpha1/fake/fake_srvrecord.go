...
var srvrecordsResource = schema.GroupVersionResource{Group: "dns.azurerm.kubeform.com", Version: "v1alpha1", Resource: "srvrecords"}

var srvrecordsKind = schema.GroupVersionKind{Group: "dns.azurerm.kubeform.com", Version: "v1alpha1", Kind: "SrvRecord"}
...
func (c *FakeSrvRecords) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SrvRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(srvrecordsResource, c.ns, name), &v1alpha1.SrvRecord{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SrvRecord), err
}
...
func (c *FakeSrvRecords) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SrvRecordList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(srvrecordsResource, srvrecordsKind, c.ns, opts), &v1alpha1.SrvRecordList{})
	...
	list := &v1alpha1.SrvRecordList{ListMeta: obj.(*v1alpha1.SrvRecordList).ListMeta}
	for _, item := range obj.(*v1alpha1.SrvRecordList).Items {
...
func (c *FakeSrvRecords) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(srvrecordsResource, c.ns, opts))
...
func (c *FakeSrvRecords) Create(ctx context.Context, srvRecord *v1alpha1.SrvRecord, opts v1.CreateOptions) (result *v1alpha1.SrvRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(srvrecordsResource, c.ns, srvRecord), &v1alpha1.SrvRecord{})
...
func (c *FakeSrvRecords) Update(ctx context.Context, srvRecord *v1alpha1.SrvRecord, opts v1.UpdateOptions) (result *v1alpha1.SrvRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(srvrecordsResource, c.ns, srvRecord), &v1alpha1.SrvRecord{})
...
func (c *FakeSrvRecords) UpdateStatus(ctx context.Context, srvRecord *v1alpha1.SrvRecord, opts v1.UpdateOptions) (*v1alpha1.SrvRecord, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(srvrecordsResource, "status", c.ns, srvRecord), &v1alpha1.SrvRecord{})
...
func (c *FakeSrvRecords) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(srvrecordsResource, c.ns, name), &v1alpha1.SrvRecord{})
...
func (c *FakeSrvRecords) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(srvrecordsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.SrvRecordList{})
	return err
}
...
func (c *FakeSrvRecords) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SrvRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(srvrecordsResource, c.ns, name, pt, data, subresources...), &v1alpha1.SrvRecord{})
