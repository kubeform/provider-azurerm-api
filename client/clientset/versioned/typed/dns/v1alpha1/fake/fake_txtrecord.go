...
var txtrecordsResource = schema.GroupVersionResource{Group: "dns.azurerm.kubeform.com", Version: "v1alpha1", Resource: "txtrecords"}

var txtrecordsKind = schema.GroupVersionKind{Group: "dns.azurerm.kubeform.com", Version: "v1alpha1", Kind: "TxtRecord"}
...
func (c *FakeTxtRecords) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TxtRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(txtrecordsResource, c.ns, name), &v1alpha1.TxtRecord{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TxtRecord), err
}
...
func (c *FakeTxtRecords) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TxtRecordList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(txtrecordsResource, txtrecordsKind, c.ns, opts), &v1alpha1.TxtRecordList{})
	...
	list := &v1alpha1.TxtRecordList{ListMeta: obj.(*v1alpha1.TxtRecordList).ListMeta}
	for _, item := range obj.(*v1alpha1.TxtRecordList).Items {
...
func (c *FakeTxtRecords) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(txtrecordsResource, c.ns, opts))
...
func (c *FakeTxtRecords) Create(ctx context.Context, txtRecord *v1alpha1.TxtRecord, opts v1.CreateOptions) (result *v1alpha1.TxtRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(txtrecordsResource, c.ns, txtRecord), &v1alpha1.TxtRecord{})
...
func (c *FakeTxtRecords) Update(ctx context.Context, txtRecord *v1alpha1.TxtRecord, opts v1.UpdateOptions) (result *v1alpha1.TxtRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(txtrecordsResource, c.ns, txtRecord), &v1alpha1.TxtRecord{})
...
func (c *FakeTxtRecords) UpdateStatus(ctx context.Context, txtRecord *v1alpha1.TxtRecord, opts v1.UpdateOptions) (*v1alpha1.TxtRecord, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(txtrecordsResource, "status", c.ns, txtRecord), &v1alpha1.TxtRecord{})
...
func (c *FakeTxtRecords) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(txtrecordsResource, c.ns, name), &v1alpha1.TxtRecord{})
...
func (c *FakeTxtRecords) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(txtrecordsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.TxtRecordList{})
	return err
}
...
func (c *FakeTxtRecords) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TxtRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(txtrecordsResource, c.ns, name, pt, data, subresources...), &v1alpha1.TxtRecord{})
