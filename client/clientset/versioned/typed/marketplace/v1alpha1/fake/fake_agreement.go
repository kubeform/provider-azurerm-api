...
var agreementsResource = schema.GroupVersionResource{Group: "marketplace.azurerm.kubeform.com", Version: "v1alpha1", Resource: "agreements"}

var agreementsKind = schema.GroupVersionKind{Group: "marketplace.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Agreement"}
...
func (c *FakeAgreements) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Agreement, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(agreementsResource, c.ns, name), &v1alpha1.Agreement{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Agreement), err
}
...
func (c *FakeAgreements) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AgreementList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(agreementsResource, agreementsKind, c.ns, opts), &v1alpha1.AgreementList{})
	...
	list := &v1alpha1.AgreementList{ListMeta: obj.(*v1alpha1.AgreementList).ListMeta}
	for _, item := range obj.(*v1alpha1.AgreementList).Items {
...
func (c *FakeAgreements) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(agreementsResource, c.ns, opts))
...
func (c *FakeAgreements) Create(ctx context.Context, agreement *v1alpha1.Agreement, opts v1.CreateOptions) (result *v1alpha1.Agreement, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(agreementsResource, c.ns, agreement), &v1alpha1.Agreement{})
...
func (c *FakeAgreements) Update(ctx context.Context, agreement *v1alpha1.Agreement, opts v1.UpdateOptions) (result *v1alpha1.Agreement, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(agreementsResource, c.ns, agreement), &v1alpha1.Agreement{})
...
func (c *FakeAgreements) UpdateStatus(ctx context.Context, agreement *v1alpha1.Agreement, opts v1.UpdateOptions) (*v1alpha1.Agreement, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(agreementsResource, "status", c.ns, agreement), &v1alpha1.Agreement{})
...
func (c *FakeAgreements) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(agreementsResource, c.ns, name), &v1alpha1.Agreement{})
...
func (c *FakeAgreements) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(agreementsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.AgreementList{})
	return err
}
...
func (c *FakeAgreements) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Agreement, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(agreementsResource, c.ns, name, pt, data, subresources...), &v1alpha1.Agreement{})
