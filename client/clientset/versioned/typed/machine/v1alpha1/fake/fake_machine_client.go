...
import (
	v1alpha1 "kubeform.dev/provider-azurerm-api/client/clientset/versioned/typed/machine/v1alpha1"
...
func (c *FakeMachineV1alpha1) LearningComputeClusters(namespace string) v1alpha1.LearningComputeClusterInterface {
...
func (c *FakeMachineV1alpha1) LearningWorkspaces(namespace string) v1alpha1.LearningWorkspaceInterface {
	return &FakeLearningWorkspaces{c, namespace}
}
