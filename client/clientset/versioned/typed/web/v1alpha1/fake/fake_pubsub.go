...
var pubsubsResource = schema.GroupVersionResource{Group: "web.azurerm.kubeform.com", Version: "v1alpha1", Resource: "pubsubs"}

var pubsubsKind = schema.GroupVersionKind{Group: "web.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Pubsub"}
...
func (c *FakePubsubs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(pubsubsResource, c.ns, listOpts)
