...
var dnscnamerecordsResource = schema.GroupVersionResource{Group: "private.azurerm.kubeform.com", Version: "v1alpha1", Resource: "dnscnamerecords"}

var dnscnamerecordsKind = schema.GroupVersionKind{Group: "private.azurerm.kubeform.com", Version: "v1alpha1", Kind: "DnsCnameRecord"}
...
func (c *FakeDnsCnameRecords) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DnsCnameRecordList, err error) {
	obj, err := c.Fake.
...
func (c *FakeDnsCnameRecords) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeDnsCnameRecords) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(dnscnamerecordsResource, c.ns, listOpts)
