...
var linkservicesResource = schema.GroupVersionResource{Group: "private.azurerm.kubeform.com", Version: "v1alpha1", Resource: "linkservices"}

var linkservicesKind = schema.GroupVersionKind{Group: "private.azurerm.kubeform.com", Version: "v1alpha1", Kind: "LinkService"}
...
func (c *FakeLinkServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LinkService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(linkservicesResource, c.ns, name), &v1alpha1.LinkService{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.LinkService), err
}
...
func (c *FakeLinkServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LinkServiceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(linkservicesResource, linkservicesKind, c.ns, opts), &v1alpha1.LinkServiceList{})
	...
	list := &v1alpha1.LinkServiceList{ListMeta: obj.(*v1alpha1.LinkServiceList).ListMeta}
	for _, item := range obj.(*v1alpha1.LinkServiceList).Items {
...
func (c *FakeLinkServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(linkservicesResource, c.ns, opts))
...
func (c *FakeLinkServices) Create(ctx context.Context, linkService *v1alpha1.LinkService, opts v1.CreateOptions) (result *v1alpha1.LinkService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(linkservicesResource, c.ns, linkService), &v1alpha1.LinkService{})
...
func (c *FakeLinkServices) Update(ctx context.Context, linkService *v1alpha1.LinkService, opts v1.UpdateOptions) (result *v1alpha1.LinkService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(linkservicesResource, c.ns, linkService), &v1alpha1.LinkService{})
...
func (c *FakeLinkServices) UpdateStatus(ctx context.Context, linkService *v1alpha1.LinkService, opts v1.UpdateOptions) (*v1alpha1.LinkService, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(linkservicesResource, "status", c.ns, linkService), &v1alpha1.LinkService{})
...
func (c *FakeLinkServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(linkservicesResource, c.ns, name), &v1alpha1.LinkService{})
...
func (c *FakeLinkServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(linkservicesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.LinkServiceList{})
	return err
}
...
func (c *FakeLinkServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LinkService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(linkservicesResource, c.ns, name, pt, data, subresources...), &v1alpha1.LinkService{})
