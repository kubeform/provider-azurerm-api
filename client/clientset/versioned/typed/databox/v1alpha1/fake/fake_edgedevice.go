...
var edgedevicesResource = schema.GroupVersionResource{Group: "databox.azurerm.kubeform.com", Version: "v1alpha1", Resource: "edgedevices"}

var edgedevicesKind = schema.GroupVersionKind{Group: "databox.azurerm.kubeform.com", Version: "v1alpha1", Kind: "EdgeDevice"}
...
func (c *FakeEdgeDevices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(edgedevicesResource, c.ns, name), &v1alpha1.EdgeDevice{})
