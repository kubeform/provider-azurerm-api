...
var databaseprincipalassignmentsResource = schema.GroupVersionResource{Group: "kusto.azurerm.kubeform.com", Version: "v1alpha1", Resource: "databaseprincipalassignments"}

var databaseprincipalassignmentsKind = schema.GroupVersionKind{Group: "kusto.azurerm.kubeform.com", Version: "v1alpha1", Kind: "DatabasePrincipalAssignment"}
...
func (c *FakeDatabasePrincipalAssignments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DatabasePrincipalAssignment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(databaseprincipalassignmentsResource, c.ns, name), &v1alpha1.DatabasePrincipalAssignment{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DatabasePrincipalAssignment), err
}
...
func (c *FakeDatabasePrincipalAssignments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DatabasePrincipalAssignmentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(databaseprincipalassignmentsResource, databaseprincipalassignmentsKind, c.ns, opts), &v1alpha1.DatabasePrincipalAssignmentList{})
	...
	list := &v1alpha1.DatabasePrincipalAssignmentList{ListMeta: obj.(*v1alpha1.DatabasePrincipalAssignmentList).ListMeta}
	for _, item := range obj.(*v1alpha1.DatabasePrincipalAssignmentList).Items {
...
func (c *FakeDatabasePrincipalAssignments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(databaseprincipalassignmentsResource, c.ns, opts))
...
func (c *FakeDatabasePrincipalAssignments) Create(ctx context.Context, databasePrincipalAssignment *v1alpha1.DatabasePrincipalAssignment, opts v1.CreateOptions) (result *v1alpha1.DatabasePrincipalAssignment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(databaseprincipalassignmentsResource, c.ns, databasePrincipalAssignment), &v1alpha1.DatabasePrincipalAssignment{})
...
func (c *FakeDatabasePrincipalAssignments) Update(ctx context.Context, databasePrincipalAssignment *v1alpha1.DatabasePrincipalAssignment, opts v1.UpdateOptions) (result *v1alpha1.DatabasePrincipalAssignment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(databaseprincipalassignmentsResource, c.ns, databasePrincipalAssignment), &v1alpha1.DatabasePrincipalAssignment{})
...
func (c *FakeDatabasePrincipalAssignments) UpdateStatus(ctx context.Context, databasePrincipalAssignment *v1alpha1.DatabasePrincipalAssignment, opts v1.UpdateOptions) (*v1alpha1.DatabasePrincipalAssignment, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(databaseprincipalassignmentsResource, "status", c.ns, databasePrincipalAssignment), &v1alpha1.DatabasePrincipalAssignment{})
...
func (c *FakeDatabasePrincipalAssignments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(databaseprincipalassignmentsResource, c.ns, name), &v1alpha1.DatabasePrincipalAssignment{})
...
func (c *FakeDatabasePrincipalAssignments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(databaseprincipalassignmentsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.DatabasePrincipalAssignmentList{})
	return err
}
...
func (c *FakeDatabasePrincipalAssignments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DatabasePrincipalAssignment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(databaseprincipalassignmentsResource, c.ns, name, pt, data, subresources...), &v1alpha1.DatabasePrincipalAssignment{})
