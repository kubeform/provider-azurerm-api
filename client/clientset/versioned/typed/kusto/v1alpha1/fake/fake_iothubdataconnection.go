...
var iothubdataconnectionsResource = schema.GroupVersionResource{Group: "kusto.azurerm.kubeform.com", Version: "v1alpha1", Resource: "iothubdataconnections"}

var iothubdataconnectionsKind = schema.GroupVersionKind{Group: "kusto.azurerm.kubeform.com", Version: "v1alpha1", Kind: "IothubDataConnection"}
...
func (c *FakeIothubDataConnections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IothubDataConnection, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(iothubdataconnectionsResource, c.ns, name), &v1alpha1.IothubDataConnection{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IothubDataConnection), err
}
...
func (c *FakeIothubDataConnections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IothubDataConnectionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(iothubdataconnectionsResource, iothubdataconnectionsKind, c.ns, opts), &v1alpha1.IothubDataConnectionList{})
	...
	list := &v1alpha1.IothubDataConnectionList{ListMeta: obj.(*v1alpha1.IothubDataConnectionList).ListMeta}
	for _, item := range obj.(*v1alpha1.IothubDataConnectionList).Items {
...
func (c *FakeIothubDataConnections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(iothubdataconnectionsResource, c.ns, opts))
...
func (c *FakeIothubDataConnections) Create(ctx context.Context, iothubDataConnection *v1alpha1.IothubDataConnection, opts v1.CreateOptions) (result *v1alpha1.IothubDataConnection, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(iothubdataconnectionsResource, c.ns, iothubDataConnection), &v1alpha1.IothubDataConnection{})
...
func (c *FakeIothubDataConnections) Update(ctx context.Context, iothubDataConnection *v1alpha1.IothubDataConnection, opts v1.UpdateOptions) (result *v1alpha1.IothubDataConnection, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(iothubdataconnectionsResource, c.ns, iothubDataConnection), &v1alpha1.IothubDataConnection{})
...
func (c *FakeIothubDataConnections) UpdateStatus(ctx context.Context, iothubDataConnection *v1alpha1.IothubDataConnection, opts v1.UpdateOptions) (*v1alpha1.IothubDataConnection, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(iothubdataconnectionsResource, "status", c.ns, iothubDataConnection), &v1alpha1.IothubDataConnection{})
...
func (c *FakeIothubDataConnections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(iothubdataconnectionsResource, c.ns, name), &v1alpha1.IothubDataConnection{})
...
func (c *FakeIothubDataConnections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(iothubdataconnectionsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.IothubDataConnectionList{})
	return err
}
...
func (c *FakeIothubDataConnections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IothubDataConnection, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(iothubdataconnectionsResource, c.ns, name, pt, data, subresources...), &v1alpha1.IothubDataConnection{})
