...
type FakePrefixes struct {
	Fake *FakePublicipV1alpha1
	ns   string
}

var prefixesResource = schema.GroupVersionResource{Group: "publicip.azurerm.kubeform.com", Version: "v1alpha1", Resource: "prefixes"}

var prefixesKind = schema.GroupVersionKind{Group: "publicip.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Prefix"}
...
func (c *FakePrefixes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(prefixesResource, c.ns, name), &v1alpha1.Prefix{})
