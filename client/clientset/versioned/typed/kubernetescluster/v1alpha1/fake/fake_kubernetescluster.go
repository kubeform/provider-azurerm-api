...
type FakeKubernetesClusters struct {
	Fake *FakeKubernetesclusterV1alpha1
	ns   string
}

var kubernetesclustersResource = schema.GroupVersionResource{Group: "kubernetescluster.azurerm.kubeform.com", Version: "v1alpha1", Resource: "kubernetesclusters"}

var kubernetesclustersKind = schema.GroupVersionKind{Group: "kubernetescluster.azurerm.kubeform.com", Version: "v1alpha1", Kind: "KubernetesCluster"}
