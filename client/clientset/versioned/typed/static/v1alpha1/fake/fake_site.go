...
var sitesResource = schema.GroupVersionResource{Group: "static.azurerm.kubeform.com", Version: "v1alpha1", Resource: "sites"}

var sitesKind = schema.GroupVersionKind{Group: "static.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Site"}
...
func (c *FakeSites) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(sitesResource, c.ns, name), &v1alpha1.Site{})
