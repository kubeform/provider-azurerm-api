...
var serversResource = schema.GroupVersionResource{Group: "sql.azurerm.kubeform.com", Version: "v1alpha1", Resource: "servers"}

var serversKind = schema.GroupVersionKind{Group: "sql.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Server"}
