...
var networkgatewaysResource = schema.GroupVersionResource{Group: "virtual.azurerm.kubeform.com", Version: "v1alpha1", Resource: "networkgateways"}

var networkgatewaysKind = schema.GroupVersionKind{Group: "virtual.azurerm.kubeform.com", Version: "v1alpha1", Kind: "NetworkGateway"}
...
func (c *FakeNetworkGateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkGateway, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(networkgatewaysResource, c.ns, name), &v1alpha1.NetworkGateway{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.NetworkGateway), err
}

// List takes label and field selectors, and returns the list of NetworkGateways that match those selectors.
func (c *FakeNetworkGateways) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkGatewayList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(networkgatewaysResource, networkgatewaysKind, c.ns, opts), &v1alpha1.NetworkGatewayList{})
	...
	list := &v1alpha1.NetworkGatewayList{ListMeta: obj.(*v1alpha1.NetworkGatewayList).ListMeta}
	for _, item := range obj.(*v1alpha1.NetworkGatewayList).Items {
...
func (c *FakeNetworkGateways) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(networkgatewaysResource, c.ns, opts))
...
func (c *FakeNetworkGateways) Create(ctx context.Context, networkGateway *v1alpha1.NetworkGateway, opts v1.CreateOptions) (result *v1alpha1.NetworkGateway, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(networkgatewaysResource, c.ns, networkGateway), &v1alpha1.NetworkGateway{})
...
func (c *FakeNetworkGateways) Update(ctx context.Context, networkGateway *v1alpha1.NetworkGateway, opts v1.UpdateOptions) (result *v1alpha1.NetworkGateway, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(networkgatewaysResource, c.ns, networkGateway), &v1alpha1.NetworkGateway{})
...
func (c *FakeNetworkGateways) UpdateStatus(ctx context.Context, networkGateway *v1alpha1.NetworkGateway, opts v1.UpdateOptions) (*v1alpha1.NetworkGateway, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(networkgatewaysResource, "status", c.ns, networkGateway), &v1alpha1.NetworkGateway{})
...
func (c *FakeNetworkGateways) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(networkgatewaysResource, c.ns, name), &v1alpha1.NetworkGateway{})
...
func (c *FakeNetworkGateways) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(networkgatewaysResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.NetworkGatewayList{})
	return err
}
...
func (c *FakeNetworkGateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkGateway, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(networkgatewaysResource, c.ns, name, pt, data, subresources...), &v1alpha1.NetworkGateway{})
