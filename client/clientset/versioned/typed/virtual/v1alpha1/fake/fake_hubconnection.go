...
var hubconnectionsResource = schema.GroupVersionResource{Group: "virtual.azurerm.kubeform.com", Version: "v1alpha1", Resource: "hubconnections"}

var hubconnectionsKind = schema.GroupVersionKind{Group: "virtual.azurerm.kubeform.com", Version: "v1alpha1", Kind: "HubConnection"}
...
func (c *FakeHubConnections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HubConnection, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(hubconnectionsResource, c.ns, name), &v1alpha1.HubConnection{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.HubConnection), err
}
...
func (c *FakeHubConnections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HubConnectionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(hubconnectionsResource, hubconnectionsKind, c.ns, opts), &v1alpha1.HubConnectionList{})
	...
	list := &v1alpha1.HubConnectionList{ListMeta: obj.(*v1alpha1.HubConnectionList).ListMeta}
	for _, item := range obj.(*v1alpha1.HubConnectionList).Items {
...
func (c *FakeHubConnections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(hubconnectionsResource, c.ns, opts))
...
func (c *FakeHubConnections) Create(ctx context.Context, hubConnection *v1alpha1.HubConnection, opts v1.CreateOptions) (result *v1alpha1.HubConnection, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(hubconnectionsResource, c.ns, hubConnection), &v1alpha1.HubConnection{})
...
func (c *FakeHubConnections) Update(ctx context.Context, hubConnection *v1alpha1.HubConnection, opts v1.UpdateOptions) (result *v1alpha1.HubConnection, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(hubconnectionsResource, c.ns, hubConnection), &v1alpha1.HubConnection{})
...
func (c *FakeHubConnections) UpdateStatus(ctx context.Context, hubConnection *v1alpha1.HubConnection, opts v1.UpdateOptions) (*v1alpha1.HubConnection, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(hubconnectionsResource, "status", c.ns, hubConnection), &v1alpha1.HubConnection{})
...
func (c *FakeHubConnections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(hubconnectionsResource, c.ns, name), &v1alpha1.HubConnection{})
...
func (c *FakeHubConnections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(hubconnectionsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.HubConnectionList{})
	return err
}
...
func (c *FakeHubConnections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HubConnection, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(hubconnectionsResource, c.ns, name, pt, data, subresources...), &v1alpha1.HubConnection{})
