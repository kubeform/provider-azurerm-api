...
var hubroutetablesResource = schema.GroupVersionResource{Group: "virtual.azurerm.kubeform.com", Version: "v1alpha1", Resource: "hubroutetables"}

var hubroutetablesKind = schema.GroupVersionKind{Group: "virtual.azurerm.kubeform.com", Version: "v1alpha1", Kind: "HubRouteTable"}
...
func (c *FakeHubRouteTables) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HubRouteTable, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(hubroutetablesResource, c.ns, name), &v1alpha1.HubRouteTable{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.HubRouteTable), err
}
...
func (c *FakeHubRouteTables) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HubRouteTableList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(hubroutetablesResource, hubroutetablesKind, c.ns, opts), &v1alpha1.HubRouteTableList{})
	...
	list := &v1alpha1.HubRouteTableList{ListMeta: obj.(*v1alpha1.HubRouteTableList).ListMeta}
	for _, item := range obj.(*v1alpha1.HubRouteTableList).Items {
...
func (c *FakeHubRouteTables) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(hubroutetablesResource, c.ns, opts))
...
func (c *FakeHubRouteTables) Create(ctx context.Context, hubRouteTable *v1alpha1.HubRouteTable, opts v1.CreateOptions) (result *v1alpha1.HubRouteTable, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(hubroutetablesResource, c.ns, hubRouteTable), &v1alpha1.HubRouteTable{})
...
func (c *FakeHubRouteTables) Update(ctx context.Context, hubRouteTable *v1alpha1.HubRouteTable, opts v1.UpdateOptions) (result *v1alpha1.HubRouteTable, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(hubroutetablesResource, c.ns, hubRouteTable), &v1alpha1.HubRouteTable{})
...
func (c *FakeHubRouteTables) UpdateStatus(ctx context.Context, hubRouteTable *v1alpha1.HubRouteTable, opts v1.UpdateOptions) (*v1alpha1.HubRouteTable, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(hubroutetablesResource, "status", c.ns, hubRouteTable), &v1alpha1.HubRouteTable{})
...
func (c *FakeHubRouteTables) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(hubroutetablesResource, c.ns, name), &v1alpha1.HubRouteTable{})
...
func (c *FakeHubRouteTables) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(hubroutetablesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.HubRouteTableList{})
	return err
}
...
func (c *FakeHubRouteTables) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HubRouteTable, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(hubroutetablesResource, c.ns, name, pt, data, subresources...), &v1alpha1.HubRouteTable{})
