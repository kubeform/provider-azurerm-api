...
var hubsResource = schema.GroupVersionResource{Group: "virtual.azurerm.kubeform.com", Version: "v1alpha1", Resource: "hubs"}

var hubsKind = schema.GroupVersionKind{Group: "virtual.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Hub"}
...
func (c *FakeHubs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Hub, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(hubsResource, c.ns, name), &v1alpha1.Hub{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Hub), err
}
...
func (c *FakeHubs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HubList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(hubsResource, hubsKind, c.ns, opts), &v1alpha1.HubList{})
	...
	list := &v1alpha1.HubList{ListMeta: obj.(*v1alpha1.HubList).ListMeta}
	for _, item := range obj.(*v1alpha1.HubList).Items {
...
func (c *FakeHubs) Create(ctx context.Context, hub *v1alpha1.Hub, opts v1.CreateOptions) (result *v1alpha1.Hub, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(hubsResource, c.ns, hub), &v1alpha1.Hub{})
...
func (c *FakeHubs) Update(ctx context.Context, hub *v1alpha1.Hub, opts v1.UpdateOptions) (result *v1alpha1.Hub, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(hubsResource, c.ns, hub), &v1alpha1.Hub{})
...
func (c *FakeHubs) UpdateStatus(ctx context.Context, hub *v1alpha1.Hub, opts v1.UpdateOptions) (*v1alpha1.Hub, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(hubsResource, "status", c.ns, hub), &v1alpha1.Hub{})
...
func (c *FakeHubs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(hubsResource, c.ns, name), &v1alpha1.Hub{})
...
func (c *FakeHubs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.HubList{})
	return err
}
...
func (c *FakeHubs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Hub, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(hubsResource, c.ns, name, pt, data, subresources...), &v1alpha1.Hub{})
