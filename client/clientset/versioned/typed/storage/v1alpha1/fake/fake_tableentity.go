...
var tableentitiesResource = schema.GroupVersionResource{Group: "storage.azurerm.kubeform.com", Version: "v1alpha1", Resource: "tableentities"}

var tableentitiesKind = schema.GroupVersionKind{Group: "storage.azurerm.kubeform.com", Version: "v1alpha1", Kind: "TableEntity"}
...
func (c *FakeTableEntities) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TableEntity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(tableentitiesResource, c.ns, name), &v1alpha1.TableEntity{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TableEntity), err
}
...
func (c *FakeTableEntities) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TableEntityList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(tableentitiesResource, tableentitiesKind, c.ns, opts), &v1alpha1.TableEntityList{})
	...
	list := &v1alpha1.TableEntityList{ListMeta: obj.(*v1alpha1.TableEntityList).ListMeta}
	for _, item := range obj.(*v1alpha1.TableEntityList).Items {
...
func (c *FakeTableEntities) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(tableentitiesResource, c.ns, opts))
...
func (c *FakeTableEntities) Create(ctx context.Context, tableEntity *v1alpha1.TableEntity, opts v1.CreateOptions) (result *v1alpha1.TableEntity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(tableentitiesResource, c.ns, tableEntity), &v1alpha1.TableEntity{})
...
func (c *FakeTableEntities) Update(ctx context.Context, tableEntity *v1alpha1.TableEntity, opts v1.UpdateOptions) (result *v1alpha1.TableEntity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(tableentitiesResource, c.ns, tableEntity), &v1alpha1.TableEntity{})
...
func (c *FakeTableEntities) UpdateStatus(ctx context.Context, tableEntity *v1alpha1.TableEntity, opts v1.UpdateOptions) (*v1alpha1.TableEntity, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(tableentitiesResource, "status", c.ns, tableEntity), &v1alpha1.TableEntity{})
...
func (c *FakeTableEntities) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(tableentitiesResource, c.ns, name), &v1alpha1.TableEntity{})
...
func (c *FakeTableEntities) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(tableentitiesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.TableEntityList{})
	return err
}
...
func (c *FakeTableEntities) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TableEntity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(tableentitiesResource, c.ns, name, pt, data, subresources...), &v1alpha1.TableEntity{})
