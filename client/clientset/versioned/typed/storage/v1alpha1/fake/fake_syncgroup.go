...
var syncgroupsResource = schema.GroupVersionResource{Group: "storage.azurerm.kubeform.com", Version: "v1alpha1", Resource: "syncgroups"}

var syncgroupsKind = schema.GroupVersionKind{Group: "storage.azurerm.kubeform.com", Version: "v1alpha1", Kind: "SyncGroup"}
...
func (c *FakeSyncGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SyncGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(syncgroupsResource, c.ns, name), &v1alpha1.SyncGroup{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SyncGroup), err
}
...
func (c *FakeSyncGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SyncGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(syncgroupsResource, syncgroupsKind, c.ns, opts), &v1alpha1.SyncGroupList{})
	...
	list := &v1alpha1.SyncGroupList{ListMeta: obj.(*v1alpha1.SyncGroupList).ListMeta}
	for _, item := range obj.(*v1alpha1.SyncGroupList).Items {
...
func (c *FakeSyncGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(syncgroupsResource, c.ns, opts))
...
func (c *FakeSyncGroups) Create(ctx context.Context, syncGroup *v1alpha1.SyncGroup, opts v1.CreateOptions) (result *v1alpha1.SyncGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(syncgroupsResource, c.ns, syncGroup), &v1alpha1.SyncGroup{})
...
func (c *FakeSyncGroups) Update(ctx context.Context, syncGroup *v1alpha1.SyncGroup, opts v1.UpdateOptions) (result *v1alpha1.SyncGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(syncgroupsResource, c.ns, syncGroup), &v1alpha1.SyncGroup{})
...
func (c *FakeSyncGroups) UpdateStatus(ctx context.Context, syncGroup *v1alpha1.SyncGroup, opts v1.UpdateOptions) (*v1alpha1.SyncGroup, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(syncgroupsResource, "status", c.ns, syncGroup), &v1alpha1.SyncGroup{})
...
func (c *FakeSyncGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(syncgroupsResource, c.ns, name), &v1alpha1.SyncGroup{})
...
func (c *FakeSyncGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(syncgroupsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.SyncGroupList{})
	return err
}
...
func (c *FakeSyncGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SyncGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(syncgroupsResource, c.ns, name, pt, data, subresources...), &v1alpha1.SyncGroup{})
