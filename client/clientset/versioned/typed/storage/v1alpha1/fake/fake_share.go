...
var sharesResource = schema.GroupVersionResource{Group: "storage.azurerm.kubeform.com", Version: "v1alpha1", Resource: "shares"}

var sharesKind = schema.GroupVersionKind{Group: "storage.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Share"}
...
func (c *FakeShares) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Share, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(sharesResource, c.ns, name), &v1alpha1.Share{})
...
func (c *FakeShares) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ShareList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(sharesResource, sharesKind, c.ns, opts), &v1alpha1.ShareList{})
...
func (c *FakeShares) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(sharesResource, c.ns, opts))
...
func (c *FakeShares) Create(ctx context.Context, share *v1alpha1.Share, opts v1.CreateOptions) (result *v1alpha1.Share, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(sharesResource, c.ns, share), &v1alpha1.Share{})
...
func (c *FakeShares) Update(ctx context.Context, share *v1alpha1.Share, opts v1.UpdateOptions) (result *v1alpha1.Share, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(sharesResource, c.ns, share), &v1alpha1.Share{})
...
func (c *FakeShares) UpdateStatus(ctx context.Context, share *v1alpha1.Share, opts v1.UpdateOptions) (*v1alpha1.Share, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(sharesResource, "status", c.ns, share), &v1alpha1.Share{})
...
func (c *FakeShares) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(sharesResource, c.ns, name), &v1alpha1.Share{})
...
func (c *FakeShares) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(sharesResource, c.ns, listOpts)
...
func (c *FakeShares) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Share, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(sharesResource, c.ns, name, pt, data, subresources...), &v1alpha1.Share{})
