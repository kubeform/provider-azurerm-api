...
var diskspoolsResource = schema.GroupVersionResource{Group: "storage.azurerm.kubeform.com", Version: "v1alpha1", Resource: "diskspools"}

var diskspoolsKind = schema.GroupVersionKind{Group: "storage.azurerm.kubeform.com", Version: "v1alpha1", Kind: "DisksPool"}
...
func (c *FakeDisksPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DisksPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(diskspoolsResource, c.ns, name), &v1alpha1.DisksPool{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DisksPool), err
}
...
func (c *FakeDisksPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DisksPoolList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(diskspoolsResource, diskspoolsKind, c.ns, opts), &v1alpha1.DisksPoolList{})
	...
	list := &v1alpha1.DisksPoolList{ListMeta: obj.(*v1alpha1.DisksPoolList).ListMeta}
	for _, item := range obj.(*v1alpha1.DisksPoolList).Items {
...
func (c *FakeDisksPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(diskspoolsResource, c.ns, opts))
...
func (c *FakeDisksPools) Create(ctx context.Context, disksPool *v1alpha1.DisksPool, opts v1.CreateOptions) (result *v1alpha1.DisksPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(diskspoolsResource, c.ns, disksPool), &v1alpha1.DisksPool{})
...
func (c *FakeDisksPools) Update(ctx context.Context, disksPool *v1alpha1.DisksPool, opts v1.UpdateOptions) (result *v1alpha1.DisksPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(diskspoolsResource, c.ns, disksPool), &v1alpha1.DisksPool{})
...
func (c *FakeDisksPools) UpdateStatus(ctx context.Context, disksPool *v1alpha1.DisksPool, opts v1.UpdateOptions) (*v1alpha1.DisksPool, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(diskspoolsResource, "status", c.ns, disksPool), &v1alpha1.DisksPool{})
...
func (c *FakeDisksPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(diskspoolsResource, c.ns, name), &v1alpha1.DisksPool{})
...
func (c *FakeDisksPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(diskspoolsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.DisksPoolList{})
	return err
}
...
func (c *FakeDisksPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DisksPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(diskspoolsResource, c.ns, name, pt, data, subresources...), &v1alpha1.DisksPool{})
