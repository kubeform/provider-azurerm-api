...
type FakeHosts struct {
	Fake *FakeBastionV1alpha1
	ns   string
}

var hostsResource = schema.GroupVersionResource{Group: "bastion.azurerm.kubeform.com", Version: "v1alpha1", Resource: "hosts"}

var hostsKind = schema.GroupVersionKind{Group: "bastion.azurerm.kubeform.com", Version: "v1alpha1", Kind: "Host"}
