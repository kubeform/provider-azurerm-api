...
// ConnectionMonitorLister helps list ConnectionMonitors.
...
// connectionMonitorLister implements the ConnectionMonitorLister interface.
type connectionMonitorLister struct {
...
func NewConnectionMonitorLister(indexer cache.Indexer) ConnectionMonitorLister {
	return &connectionMonitorLister{indexer: indexer}
}

// List lists all ConnectionMonitors in the indexer.
func (s *connectionMonitorLister) List(selector labels.Selector) (ret []*v1alpha1.ConnectionMonitor, err error) {
...
func (s connectionMonitorNamespaceLister) Get(name string) (*v1alpha1.ConnectionMonitor, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("connectionmonitor"), name)
	}
	return obj.(*v1alpha1.ConnectionMonitor), nil
}
