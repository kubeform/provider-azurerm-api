...
// IothubLister helps list Iothubs.
...
// iothubLister implements the IothubLister interface.
type iothubLister struct {
	indexer cache.Indexer
}

// NewIothubLister returns a new IothubLister.
func NewIothubLister(indexer cache.Indexer) IothubLister {
	return &iothubLister{indexer: indexer}
}

// List lists all Iothubs in the indexer.
func (s *iothubLister) List(selector labels.Selector) (ret []*v1alpha1.Iothub, err error) {
...
func (s iothubNamespaceLister) Get(name string) (*v1alpha1.Iothub, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("iothub"), name)
	}
	return obj.(*v1alpha1.Iothub), nil
}
