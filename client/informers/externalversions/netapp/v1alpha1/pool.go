	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetappV1alpha1().Pools(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetappV1alpha1().Pools(namespace).Watch(context.TODO(), options)
			},
		},
		&netappv1alpha1.Pool{},
		resyncPeriod,
...
func (f *poolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&netappv1alpha1.Pool{}, f.defaultInformer)
}
