...
import (
	...
	v1alpha1 "kubeform.dev/provider-azurerm-api/client/listers/custom/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CustomV1alpha1().Providers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CustomV1alpha1().Providers(namespace).Watch(context.TODO(), options)
			},
		},
		&customv1alpha1.Provider{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *providerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&customv1alpha1.Provider{}, f.defaultInformer)
}
