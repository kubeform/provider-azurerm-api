	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DevtestV1alpha1().Policies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DevtestV1alpha1().Policies(namespace).Watch(context.TODO(), options)
			},
		},
		&devtestv1alpha1.Policy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *policyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&devtestv1alpha1.Policy{}, f.defaultInformer)
}
