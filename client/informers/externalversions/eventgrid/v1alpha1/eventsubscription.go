	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EventgridV1alpha1().EventSubscriptions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventgridV1alpha1().EventSubscriptions(namespace).Watch(context.TODO(), options)
			},
		},
		&eventgridv1alpha1.EventSubscription{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *eventSubscriptionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventgridv1alpha1.EventSubscription{}, f.defaultInformer)
}
