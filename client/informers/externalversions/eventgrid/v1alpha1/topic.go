	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EventgridV1alpha1().Topics(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventgridV1alpha1().Topics(namespace).Watch(context.TODO(), options)
			},
		},
		&eventgridv1alpha1.Topic{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *topicInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventgridv1alpha1.Topic{}, f.defaultInformer)
}
