...
import (
	...
	v1alpha1 "kubeform.dev/provider-azurerm-api/client/listers/publicip/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PublicipV1alpha1().PublicIPs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PublicipV1alpha1().PublicIPs(namespace).Watch(context.TODO(), options)
			},
		},
		&publicipv1alpha1.PublicIP{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *publicIPInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&publicipv1alpha1.PublicIP{}, f.defaultInformer)
}
