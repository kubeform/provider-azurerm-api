	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PublicipV1alpha1().Prefixes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PublicipV1alpha1().Prefixes(namespace).Watch(context.TODO(), options)
			},
		},
		&publicipv1alpha1.Prefix{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *prefixInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&publicipv1alpha1.Prefix{}, f.defaultInformer)
}
