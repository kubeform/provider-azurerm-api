	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FrontdoorV1alpha1().FirewallPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FrontdoorV1alpha1().FirewallPolicies(namespace).Watch(context.TODO(), options)
			},
		},
		&frontdoorv1alpha1.FirewallPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *firewallPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&frontdoorv1alpha1.FirewallPolicy{}, f.defaultInformer)
}
