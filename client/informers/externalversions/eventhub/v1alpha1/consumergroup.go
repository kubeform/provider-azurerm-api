	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EventhubV1alpha1().ConsumerGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventhubV1alpha1().ConsumerGroups(namespace).Watch(context.TODO(), options)
			},
		},
		&eventhubv1alpha1.ConsumerGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *consumerGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventhubv1alpha1.ConsumerGroup{}, f.defaultInformer)
}
