	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IothubV1alpha1().Iothubs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IothubV1alpha1().Iothubs(namespace).Watch(context.TODO(), options)
			},
		},
		&iothubv1alpha1.Iothub{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *iothubInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&iothubv1alpha1.Iothub{}, f.defaultInformer)
}
