	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppV1alpha1().ServicePlans(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppV1alpha1().ServicePlans(namespace).Watch(context.TODO(), options)
			},
		},
		&appv1alpha1.ServicePlan{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *servicePlanInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appv1alpha1.ServicePlan{}, f.defaultInformer)
}
