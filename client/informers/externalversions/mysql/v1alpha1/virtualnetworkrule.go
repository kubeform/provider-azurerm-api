	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MysqlV1alpha1().VirtualNetworkRules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MysqlV1alpha1().VirtualNetworkRules(namespace).Watch(context.TODO(), options)
			},
		},
		&mysqlv1alpha1.VirtualNetworkRule{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *virtualNetworkRuleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mysqlv1alpha1.VirtualNetworkRule{}, f.defaultInformer)
}
