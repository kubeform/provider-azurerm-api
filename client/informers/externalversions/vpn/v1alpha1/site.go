	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VpnV1alpha1().Sites(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VpnV1alpha1().Sites(namespace).Watch(context.TODO(), options)
			},
		},
		&vpnv1alpha1.Site{},
		resyncPeriod,
...
func (f *siteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&vpnv1alpha1.Site{}, f.defaultInformer)
}
