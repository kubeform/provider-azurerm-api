...
// ServerConfigurations returns a ServerConfigurationInformer.
func (v *version) ServerConfigurations() ServerConfigurationInformer {
	return &serverConfigurationInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
