	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ResourceV1alpha1().PolicyAssignments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ResourceV1alpha1().PolicyAssignments(namespace).Watch(context.TODO(), options)
			},
		},
		&resourcev1alpha1.PolicyAssignment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *policyAssignmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&resourcev1alpha1.PolicyAssignment{}, f.defaultInformer)
}
