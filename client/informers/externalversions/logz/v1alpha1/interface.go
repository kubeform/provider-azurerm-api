...
type Interface interface {
	...
	// TagRules returns a TagRuleInformer.
	TagRules() TagRuleInformer
}
...
// TagRules returns a TagRuleInformer.
func (v *version) TagRules() TagRuleInformer {
	return &tagRuleInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
