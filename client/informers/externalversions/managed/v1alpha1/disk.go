	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ManagedV1alpha1().Disks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ManagedV1alpha1().Disks(namespace).Watch(context.TODO(), options)
			},
		},
		&managedv1alpha1.Disk{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *diskInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&managedv1alpha1.Disk{}, f.defaultInformer)
}
