	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LogicappV1alpha1().Workflows(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LogicappV1alpha1().Workflows(namespace).Watch(context.TODO(), options)
			},
		},
		&logicappv1alpha1.Workflow{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workflowInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&logicappv1alpha1.Workflow{}, f.defaultInformer)
}
