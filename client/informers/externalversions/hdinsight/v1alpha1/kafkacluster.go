	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.HdinsightV1alpha1().KafkaClusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.HdinsightV1alpha1().KafkaClusters(namespace).Watch(context.TODO(), options)
			},
		},
		&hdinsightv1alpha1.KafkaCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kafkaClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&hdinsightv1alpha1.KafkaCluster{}, f.defaultInformer)
}
