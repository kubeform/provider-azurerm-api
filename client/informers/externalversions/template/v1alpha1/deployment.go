...
import (
	...
	v1alpha1 "kubeform.dev/provider-azurerm-api/client/listers/template/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TemplateV1alpha1().Deployments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TemplateV1alpha1().Deployments(namespace).Watch(context.TODO(), options)
			},
		},
		&templatev1alpha1.Deployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *deploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&templatev1alpha1.Deployment{}, f.defaultInformer)
}
