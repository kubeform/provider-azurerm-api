...
import (
	...
	v1alpha1 "kubeform.dev/provider-azurerm-api/client/listers/route/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RouteV1alpha1().Filters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RouteV1alpha1().Filters(namespace).Watch(context.TODO(), options)
			},
		},
		&routev1alpha1.Filter{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *filterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&routev1alpha1.Filter{}, f.defaultInformer)
}
