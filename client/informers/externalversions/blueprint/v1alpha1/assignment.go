...
import (
	...
	v1alpha1 "kubeform.dev/provider-azurerm-api/client/listers/blueprint/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BlueprintV1alpha1().Assignments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BlueprintV1alpha1().Assignments(namespace).Watch(context.TODO(), options)
			},
		},
		&blueprintv1alpha1.Assignment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *assignmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&blueprintv1alpha1.Assignment{}, f.defaultInformer)
}
