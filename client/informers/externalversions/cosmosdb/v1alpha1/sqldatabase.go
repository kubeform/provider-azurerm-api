	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CosmosdbV1alpha1().SqlDatabases(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CosmosdbV1alpha1().SqlDatabases(namespace).Watch(context.TODO(), options)
			},
		},
		&cosmosdbv1alpha1.SqlDatabase{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sqlDatabaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cosmosdbv1alpha1.SqlDatabase{}, f.defaultInformer)
}
