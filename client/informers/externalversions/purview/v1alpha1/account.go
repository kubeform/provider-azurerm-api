...
import (
	...
	v1alpha1 "kubeform.dev/provider-azurerm-api/client/listers/purview/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PurviewV1alpha1().Accounts(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PurviewV1alpha1().Accounts(namespace).Watch(context.TODO(), options)
			},
		},
		&purviewv1alpha1.Account{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *accountInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&purviewv1alpha1.Account{}, f.defaultInformer)
}
