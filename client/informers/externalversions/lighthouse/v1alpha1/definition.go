...
import (
	...
	v1alpha1 "kubeform.dev/provider-azurerm-api/client/listers/lighthouse/v1alpha1"
...
type DefinitionInformer interface {
	...
	Lister() v1alpha1.DefinitionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LighthouseV1alpha1().Definitions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LighthouseV1alpha1().Definitions(namespace).Watch(context.TODO(), options)
			},
		},
		&lighthousev1alpha1.Definition{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *definitionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&lighthousev1alpha1.Definition{}, f.defaultInformer)
}

func (f *definitionInformer) Lister() v1alpha1.DefinitionLister {
	return v1alpha1.NewDefinitionLister(f.Informer().GetIndexer())
}
