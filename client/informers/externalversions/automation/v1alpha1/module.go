	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AutomationV1alpha1().Modules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutomationV1alpha1().Modules(namespace).Watch(context.TODO(), options)
			},
		},
		&automationv1alpha1.Module{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *moduleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&automationv1alpha1.Module{}, f.defaultInformer)
}
