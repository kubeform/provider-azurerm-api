	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MssqlV1alpha1().Servers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MssqlV1alpha1().Servers(namespace).Watch(context.TODO(), options)
			},
		},
		&mssqlv1alpha1.Server{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serverInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mssqlv1alpha1.Server{}, f.defaultInformer)
}
