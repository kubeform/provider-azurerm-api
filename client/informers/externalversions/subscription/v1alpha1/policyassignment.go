...
// PolicyAssignmentInformer provides access to a shared informer and lister for
// PolicyAssignments.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SubscriptionV1alpha1().PolicyAssignments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SubscriptionV1alpha1().PolicyAssignments(namespace).Watch(context.TODO(), options)
			},
		},
		&subscriptionv1alpha1.PolicyAssignment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *policyAssignmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&subscriptionv1alpha1.PolicyAssignment{}, f.defaultInformer)
}

func (f *policyAssignmentInformer) Lister() v1alpha1.PolicyAssignmentLister {
	return v1alpha1.NewPolicyAssignmentLister(f.Informer().GetIndexer())
}
