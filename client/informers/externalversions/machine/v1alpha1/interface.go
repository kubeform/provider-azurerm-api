...
// LearningComputeClusters returns a LearningComputeClusterInformer.
func (v *version) LearningComputeClusters() LearningComputeClusterInformer {
...
// LearningWorkspaces returns a LearningWorkspaceInformer.
func (v *version) LearningWorkspaces() LearningWorkspaceInformer {
	return &learningWorkspaceInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
