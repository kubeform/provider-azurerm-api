	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VirtualV1alpha1().Hubs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VirtualV1alpha1().Hubs(namespace).Watch(context.TODO(), options)
			},
		},
		&virtualv1alpha1.Hub{},
		resyncPeriod,
...
func (f *hubInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&virtualv1alpha1.Hub{}, f.defaultInformer)
}

func (f *hubInformer) Lister() v1alpha1.HubLister {
	return v1alpha1.NewHubLister(f.Informer().GetIndexer())
}
