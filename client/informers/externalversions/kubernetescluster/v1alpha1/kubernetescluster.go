...
import (
	...
	v1alpha1 "kubeform.dev/provider-azurerm-api/client/listers/kubernetescluster/v1alpha1"
...
type KubernetesClusterInformer interface {
	...
	Lister() v1alpha1.KubernetesClusterLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubernetesclusterV1alpha1().KubernetesClusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubernetesclusterV1alpha1().KubernetesClusters(namespace).Watch(context.TODO(), options)
			},
		},
		&kubernetesclusterv1alpha1.KubernetesCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kubernetesClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubernetesclusterv1alpha1.KubernetesCluster{}, f.defaultInformer)
}

func (f *kubernetesClusterInformer) Lister() v1alpha1.KubernetesClusterLister {
	return v1alpha1.NewKubernetesClusterLister(f.Informer().GetIndexer())
}
