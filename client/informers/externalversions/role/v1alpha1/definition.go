	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RoleV1alpha1().Definitions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RoleV1alpha1().Definitions(namespace).Watch(context.TODO(), options)
			},
		},
		&rolev1alpha1.Definition{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *definitionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rolev1alpha1.Definition{}, f.defaultInformer)
}
