...
func (in *AccessPolicySpec) DeepCopyInto(out *AccessPolicySpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(AccessPolicySpecResource)
		(*in).DeepCopyInto(*out)
	}
...
func (in *AccessPolicySpecResource) DeepCopy() *AccessPolicySpecResource {
	if in == nil {
		return nil
	}
	out := new(AccessPolicySpecResource)
...
func (in *CertificateIssuerSpec) DeepCopyInto(out *CertificateIssuerSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(CertificateIssuerSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CertificateIssuerSpecResource) DeepCopyInto(out *CertificateIssuerSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *CertificateIssuerSpecResource) DeepCopy() *CertificateIssuerSpecResource {
	if in == nil {
		return nil
	}
	out := new(CertificateIssuerSpecResource)
...
func (in *KeyVaultSpecResource) DeepCopy() *KeyVaultSpecResource {
	if in == nil {
		return nil
	}
	out := new(KeyVaultSpecResource)
...
func (in *ManagedHardwareSecurityModuleSpec) DeepCopyInto(out *ManagedHardwareSecurityModuleSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(ManagedHardwareSecurityModuleSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedHardwareSecurityModuleSpecResource) DeepCopyInto(out *ManagedHardwareSecurityModuleSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *ManagedHardwareSecurityModuleSpecResource) DeepCopy() *ManagedHardwareSecurityModuleSpecResource {
	if in == nil {
		return nil
	}
	out := new(ManagedHardwareSecurityModuleSpecResource)
