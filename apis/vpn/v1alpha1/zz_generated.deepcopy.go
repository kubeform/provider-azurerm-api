...
func (in *GatewayConnectionSpec) DeepCopyInto(out *GatewayConnectionSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(GatewayConnectionSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GatewayConnectionSpecResource) DeepCopyInto(out *GatewayConnectionSpecResource) {
	*out = *in
	if in.Timeouts != nil {
...
func (in *GatewayConnectionSpecResource) DeepCopy() *GatewayConnectionSpecResource {
	if in == nil {
		return nil
	}
	out := new(GatewayConnectionSpecResource)
...
func (in *ServerConfigurationSpec) DeepCopyInto(out *ServerConfigurationSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(ServerConfigurationSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerConfigurationSpecResource) DeepCopyInto(out *ServerConfigurationSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *ServerConfigurationSpecResource) DeepCopy() *ServerConfigurationSpecResource {
	if in == nil {
		return nil
	}
	out := new(ServerConfigurationSpecResource)
