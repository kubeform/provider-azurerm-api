...
func (in *RemediationSpec) DeepCopyInto(out *RemediationSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(RemediationSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *RemediationSpecResource) DeepCopy() *RemediationSpecResource {
	if in == nil {
		return nil
	}
	out := new(RemediationSpecResource)
...
func (in *SetDefinitionSpec) DeepCopyInto(out *SetDefinitionSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(SetDefinitionSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SetDefinitionSpecResource) DeepCopyInto(out *SetDefinitionSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *SetDefinitionSpecResource) DeepCopy() *SetDefinitionSpecResource {
	if in == nil {
		return nil
	}
	out := new(SetDefinitionSpecResource)
