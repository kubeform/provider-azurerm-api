...
func (in *ActiveDirectoryAdministratorSpec) DeepCopyInto(out *ActiveDirectoryAdministratorSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(ActiveDirectoryAdministratorSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
func (in *FlexibleServerFirewallRuleSpec) DeepCopyInto(out *FlexibleServerFirewallRuleSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(FlexibleServerFirewallRuleSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlexibleServerFirewallRuleSpecResource) DeepCopyInto(out *FlexibleServerFirewallRuleSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *FlexibleServerFirewallRuleSpecResource) DeepCopy() *FlexibleServerFirewallRuleSpecResource {
	if in == nil {
		return nil
	}
	out := new(FlexibleServerFirewallRuleSpecResource)
...
func (in *FlexibleServerSpec) DeepCopyInto(out *FlexibleServerSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(FlexibleServerSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlexibleServerSpecResource) DeepCopyInto(out *FlexibleServerSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *FlexibleServerSpecResource) DeepCopy() *FlexibleServerSpecResource {
	if in == nil {
		return nil
	}
	out := new(FlexibleServerSpecResource)
...
func (in *ServerKeySpecResource) DeepCopy() *ServerKeySpecResource {
	if in == nil {
		return nil
	}
	out := new(ServerKeySpecResource)
