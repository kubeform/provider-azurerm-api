...
func (in *TwinsEndpointEventgridSpec) DeepCopyInto(out *TwinsEndpointEventgridSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(TwinsEndpointEventgridSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
func (in *TwinsEndpointEventhubSpec) DeepCopyInto(out *TwinsEndpointEventhubSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(TwinsEndpointEventhubSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *TwinsEndpointServicebusSpec) DeepCopyInto(out *TwinsEndpointServicebusSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(TwinsEndpointServicebusSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *TwinsInstanceSpec) DeepCopyInto(out *TwinsInstanceSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(TwinsInstanceSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
