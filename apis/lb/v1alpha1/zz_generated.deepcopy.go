...
func (in *BackendAddressPoolAddressSpec) DeepCopyInto(out *BackendAddressPoolAddressSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(BackendAddressPoolAddressSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
func (in *BackendAddressPoolSpec) DeepCopyInto(out *BackendAddressPoolSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(BackendAddressPoolSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *OutboundRuleSpec) DeepCopyInto(out *OutboundRuleSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(OutboundRuleSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
