...
func (in *NamespaceNetworkRuleSetSpec) DeepCopyInto(out *NamespaceNetworkRuleSetSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(NamespaceNetworkRuleSetSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NamespaceNetworkRuleSetSpecResource) DeepCopyInto(out *NamespaceNetworkRuleSetSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *NamespaceNetworkRuleSetSpecResource) DeepCopy() *NamespaceNetworkRuleSetSpecResource {
	if in == nil {
		return nil
	}
	out := new(NamespaceNetworkRuleSetSpecResource)
...
func (in *QueueAuthorizationRuleSpec) DeepCopyInto(out *QueueAuthorizationRuleSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(QueueAuthorizationRuleSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QueueAuthorizationRuleSpecResource) DeepCopyInto(out *QueueAuthorizationRuleSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *QueueAuthorizationRuleSpecResource) DeepCopy() *QueueAuthorizationRuleSpecResource {
	if in == nil {
		return nil
	}
	out := new(QueueAuthorizationRuleSpecResource)
...
func (in *SubscriptionRuleSpec) DeepCopyInto(out *SubscriptionRuleSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(SubscriptionRuleSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubscriptionRuleSpecResource) DeepCopyInto(out *SubscriptionRuleSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *SubscriptionRuleSpecResource) DeepCopy() *SubscriptionRuleSpecResource {
	if in == nil {
		return nil
	}
	out := new(SubscriptionRuleSpecResource)
...
func (in *TopicAuthorizationRuleSpec) DeepCopyInto(out *TopicAuthorizationRuleSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(TopicAuthorizationRuleSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TopicAuthorizationRuleSpecResource) DeepCopyInto(out *TopicAuthorizationRuleSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *TopicAuthorizationRuleSpecResource) DeepCopy() *TopicAuthorizationRuleSpecResource {
	if in == nil {
		return nil
	}
	out := new(TopicAuthorizationRuleSpecResource)
