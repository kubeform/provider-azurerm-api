...
func (in *CustomHTTPSConfigurationSpec) DeepCopyInto(out *CustomHTTPSConfigurationSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(CustomHTTPSConfigurationSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomHTTPSConfigurationSpecResource) DeepCopyInto(out *CustomHTTPSConfigurationSpecResource) {
	*out = *in
	if in.Timeouts != nil {
...
func (in *CustomHTTPSConfigurationSpecResource) DeepCopy() *CustomHTTPSConfigurationSpecResource {
	if in == nil {
		return nil
	}
	out := new(CustomHTTPSConfigurationSpecResource)
...
func (in *FirewallPolicySpec) DeepCopyInto(out *FirewallPolicySpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(FirewallPolicySpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FirewallPolicySpecResource) DeepCopyInto(out *FirewallPolicySpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *FirewallPolicySpecResource) DeepCopy() *FirewallPolicySpecResource {
	if in == nil {
		return nil
	}
	out := new(FirewallPolicySpecResource)
...
func (in *FrontdoorSpecResource) DeepCopy() *FrontdoorSpecResource {
	if in == nil {
		return nil
	}
	out := new(FrontdoorSpecResource)
